<?php
/**
 * Archive template — カテゴリ / タグ / 日付別アーカイブ
 *
...
<main class="site-main" id="site-main" role="main">
  <div class="content-layout">
    <div class="content-layout__main">
      ...
      if ( $description ) :
      ?>
        <div class="archive-description" style="margin-bottom: var(--space-6); color: var(--color-medium);"><?php echo wp_kses_post( $description ); ?></div>
      <?php endif; ?>
            ...
            <article <?php post_class( 'article-card' ); ?>>
              <a class="article-card__link" href="<?php the_permalink(); ?>" aria-label="<?php echo esc_attr( wp_strip_all_tags( get_the_title() ) ); ?> を読む" style="text-decoration:none;color:inherit;display:flex;flex-direction:column;flex:1;">
                <div class="article-card__media">
                  ...
                  <?php else : ?>
                    <img class="article-card__image" src="<?php echo esc_url( affinger4_child_placeholder_image_url() ); ?>" alt="" loading="lazy">
                  <?php endif; ?>
                </div>
      ...
      <?php else : ?>
        <p style="padding: 2rem 0; color: var(--color-muted);">このアーカイブには記事がまだありません。</p>
      <?php endif; ?>
