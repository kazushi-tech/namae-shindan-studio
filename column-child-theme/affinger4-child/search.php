  ...
  <div class="content-layout">
    <div class="content-layout__main">
      ...
      <div class="page-header">
        <h1 class="page-header__title">「<?php echo esc_html( get_search_query() ); ?>」の検索結果</h1>
        <?php
        global $wp_query;
      ...
      <?php else : ?>
        <p style="padding: 2rem 0; color: var(--color-muted);">該当する記事が見つかりませんでした。キーワードを変えてお試しください。</p>
      <?php endif; ?>
